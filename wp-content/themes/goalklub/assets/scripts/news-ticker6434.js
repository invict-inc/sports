	...
	jQuery.fn[name] = function(options) {
		...
		if (tickerData.controls || tickerData.ownControls) {
			if (!tickerData.ownControls) {
				$('<ul class="ticker-controls"><li class="play"><a href="#play">Play</a></li><li class="resume"><a href="#resume">Resume</a></li><li class="stop"><a href="#stop"></a></li><li class="previous"><a href="#previous"><em class="icon-chevron-left"></em></a></li><li class="next"><a href="#next"><em class="icon-chevron-right"></em></a></li></ul>').insertAfter($(tickerData.newsList));
			}
			$('.play').hide();
		    $('.resume').hide();
